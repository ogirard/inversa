...
/**
 * SyrinxProject filter form base class.
 *
 * @package    syrinx
 * @subpackage filter
 ...
 */
abstract class BaseSyrinxProjectFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('syrinx_project_filters[%s]');
