...
/**
 * SyrinxProject form base class.
 *
 * @method SyrinxProject getObject() Returns the current form's model object
 *
 * @package    syrinx
 * @subpackage form
 ...
 */
abstract class BaseSyrinxProjectForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('syrinx_project[%s]');
