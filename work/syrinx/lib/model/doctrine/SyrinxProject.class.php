 ...
 */
class SyrinxProject extends BaseSyrinxProject
{
    ...
    public function postDelete($event) {      
        @unlink(sfConfig::get('sf_upload_dir').'/project/images/'.$this->getImage());
        @unlink(sfConfig::get('sf_upload_dir').'/project/images/'.$this->getThumbImage());
        foreach ($this->getFiles() as $name => $path) {
            @unlink(sfConfig::get('sf_upload_dir').'/project/files/'.$path);
        }
    }
}
