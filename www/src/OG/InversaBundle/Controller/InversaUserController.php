...
use OG\InversaBundle\Form\NewInversaUserType;
...
class InversaUserController extends Controller
{
  ...
  public function newAction()
  {
    ...
    $form = $this->createForm(new NewInversaUserType(), $entity);
  ...
  public function createAction()
  {
    ...
    $entity->setIsOldPasswordOk(true);
    ...
    if ($form->isValid()) {
      ...
      $password = $encoder->encodePassword($entity->getNewpassword(), $entity->getSalt());
  ...
  public function updateAction($id)
  {
    ...
    if ($entity->getNewpassword() !== null) {
      $factory = $this->get('security.encoder_factory');
      $encoder = $factory->getEncoder($entity);
      $currentPassword = $encoder->encodePassword($entity->getNewpassword(), $entity->getSalt());
      $isOldPasswordOk = $encoder->isPasswordValid($entity->getPassword(), $entity->getOldpassword(), $entity->getSalt());
    } 
    
    $entity->setIsOldPasswordOk($isOldPasswordOk);
