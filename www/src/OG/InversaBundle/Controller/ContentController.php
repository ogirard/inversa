...
class ContentController extends Controller {
	...
	public function inversaAction() {
		return $this
				->render('OGInversaBundle:Content:inversa.html.twig',
						array('name' => 'inversa'));
	}
	...
	public function panfluteAction() {
		return $this
				->render('OGInversaBundle:Content:panflute.html.twig',
						array('name' => 'panflute'));
	}
	...
	public function violinAction() {
		return $this
				->render('OGInversaBundle:Content:violin.html.twig',
						array('name' => 'violin'));
	}
	...
	public function fluteAction() {
		return $this
				->render('OGInversaBundle:Content:flute.html.twig',
						array('name' => 'flute'));
	}
	...
	public function organAction() {
		return $this
				->render('OGInversaBundle:Content:organ.html.twig',
						array('name' => 'organ'));
	}
	...
	public function agendaAction() {
		...
		$query = $em->getRepository('OGInversaBundle:AgendaItem')
				->createQueryBuilder('a')->where('a.eventdate > :archivedate')
				->setParameter('archivedate', date('Y-m-d h:i:s', $archiveDate))
				->orderBy('a.eventdate', 'ASC')->getQuery();
	...
	public function agendaarchiveAction() {
		...
		$query = $em->getRepository('OGInversaBundle:AgendaItem')
				->createQueryBuilder('a')->where('a.eventdate <= :archivedate')
				->setParameter('archivedate', date('Y-m-d h:i:s', $archiveDate))
				->orderBy('a.eventdate', 'DESC')->getQuery();
		$entities = $query->getResult();

		return $this
				->render('OGInversaBundle:Content:agendaarchive.html.twig',
						array('name' => 'agendaarchive',
								'entities' => $entities));
	}
	...
	public function projectsAction() {
		return $this
				->render('OGInversaBundle:Content:projects.html.twig',
						array('name' => 'projects'));
	}
	...
	public function mediaAction() {
		return $this
				->render('OGInversaBundle:Content:audiosamples.html.twig',
						array('name' => 'examples'));
	}
	...
	public function mediaVideosAction() {
		return $this
				->render('OGInversaBundle:Content:videos.html.twig',
						array('name' => 'videos'));
	}
	...
	public function mediaPressAction() {
		return $this
				->render('OGInversaBundle:Content:press.html.twig',
						array('name' => 'press'));
	}
	...
	public function mediaSamplesAction() {
		return $this
				->render('OGInversaBundle:Content:downloads.html.twig',
	...
	public function galleryAction() {
		return $this
				->render('OGInversaBundle:Content:galleries.html.twig',
						array('name' => 'gallery'));
	}
	...
	public function cdsAction() {
		return $this
				->render('OGInversaBundle:Content:cds.html.twig',
						array('name' => 'cds'));
	}
	...
	public function contactAction() {
		...
		$mailData = array();
		$form = $this
				->createFormBuilder($mailData,
						array('validation_constraint' => $mailDataValidation))
				->add('name', 'text',
						array('required' => false, 'label' => 'Name'))
				->add('email', 'email',
						array('required' => false, 'label' => 'E-Mail'))
				->add('message', 'textarea',
						array('required' => false, 'label' => 'Nachricht'))
				->add('captcha', 'captcha',
						array('width' => '100', 'height' => '32',
			...
			if ($form->isValid()) {
				...
				$message = \Swift_Message::newInstance()
						...
						->setBody(
								$this
										->renderView(
												'OGInversaBundle:Content:email.txt.twig',
												$data));

				$this->get('mailer')->send($message);
				return $this
						->render(
								'OGInversaBundle:Content:mailconfirm.html.twig',
								array('name' => 'contact',
										'email' => $data['email']));
			}
		}
